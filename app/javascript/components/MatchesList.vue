...
<template>
  ...
  <div>
    ...
    <b-table striped hover
      ...
      <template slot="challenged" scope="data">
        {{data.value.username}}
        ...
        <b-button target="" variant="info"
                  ...
                  :to="{name:'match_performance_edit',params:{id:data.item.challenged_performance.id}}">
          <vf-icon icon="road"/>
        </b-button>
        </template>
