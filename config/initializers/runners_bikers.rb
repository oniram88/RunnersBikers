module RunnersBikers
  ...
  MIN_PERFORMANCE_INSERT = PROGRAMM_STATUS == 'test' ? Time.now - 1.month : Time.zone.parse('2018-06-16 00:00:00')

  # Tempo massimo inserimento Performance prima della fine della gara
  MAX_PERFORMANCE_INSERT = PROGRAMM_STATUS == 'test' ? Time.now + 1.month : Time.zone.parse('2018-07-23 00:00:00') + 2.hours
  ...
  TIME_TO_START_CHALLENGES = PROGRAMM_STATUS == 'test' ? Time.now - 1.day : Time.zone.parse('2018-06-30 00:00:00')
